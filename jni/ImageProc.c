...
void 
Java_bbk_usbcamera_CameraPreview_pixeltobmp( JNIEnv* env,jobject thiz,jobject bitmap){
...
jint 
Java_bbk_usbcamera_CameraPreview_prepareCamera( JNIEnv* env,jobject thiz, jint videoid){
...
jint 
Java_bbk_usbcamera_CameraPreview_prepareCameraWithBase( JNIEnv* env,jobject thiz, jint videoid, jint videobase){
	
		int ret;

		camerabase = videobase;
	
		return Java_bbk_usbcamera_CameraPreview_prepareCamera(env,thiz,videoid);
	
}

void 
Java_bbk_usbcamera_CameraPreview_processCamera( JNIEnv* env,
										jobject thiz){
...
void 
Java_bbk_usbcamera_CameraPreview_stopCamera(JNIEnv* env,jobject thiz){
